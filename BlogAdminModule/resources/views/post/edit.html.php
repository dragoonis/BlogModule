    ...
    <div id="add-blog-post" class="widget-box">
        ...
        <div class="widget-content">
            ...
            <div class="blog-post-form">
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <input type="text" class="input-xxlarge validate[required]"
                                   id="title" placeholder='Title' name="title" value="<?=$post->getTitle();?>">
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <textarea class="input-xxlarge" id="content" name="content" cols="45" rows="24"><?=$post->getContent();?></textarea>
                        ...
                        <?php foreach ($cats as $cat) : ?>
                            <div class="controls">
                                <input type="checkbox" id="category[]" name="category[]"
                                       value="<?= $cat->getId(); ?>"  <?= in_array($cat->getTitle(), $postCats) ? 'checked' : '' ;?>  > <?=$cat->getTitle();?>
                            </div>
                        <?php endforeach; ?>
                    </div>
                </div>
